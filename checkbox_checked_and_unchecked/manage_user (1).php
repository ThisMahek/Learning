   ...
   <div class="modal fade" id="add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                      ...
                      <form   action="<?= base_url('Users/add_users')?>" method="post" enctype="multipart/form-data"  form_payment>
                          <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                       <label class="mb-2">Experiencccce</label>
                                       <input type="number" name="experience" class="form-control"  onkeypress="return isExperience(event)" required>
                ...
                <!--</div>-->
                        ...
                        <div class="mb-3"    id="pincode_div">
                                       <label class="mb-2">Pincode</label>
                                       <input type="text" class="form-control" name="pincode"  onkeypress="return isNumber(event)" maxlength="6"   id="pincode"  required>
     ...
     if(JSON.stringify(CollectArr)==JSON.stringify(AllCollectArr))
     {
        ...
        success:function(data)
        {
            if(data==1)
                {
                    setTimeout(function(){
                    $('#show_message').html('<div class="alert alert-success text-center" id="successMessage">Status changed successfully!</div>');
                    window.location.reload();
                    },1000
                    );
                }else{
                    setTimeout(function(){
                    $('#show_message').html('<div class="alert alert-danger text-center" id="successMessage">Unabel to change status!</div>');
                    window.location.reload();
                    },1000
                    );
                }
